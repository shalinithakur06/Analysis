...
void Analyzer::CutFlowProcessor(TString url,  string myKey, TString cutflowType, TFile *outFile_){
  ...
  for(int i=0; i<nEntries; ++i){
    ...
    //---------------------------------------------------//
    double lumi_BCDEF = 18.85; double lumi_GH = 15.84;	
    ...
    fillHisto(outFile_, cutflowType_, "PreSel","eta_Z",  50, 0, 500, vZ.Rapidity(), evtWeight );
    fillHisto(outFile_, cutflowType_, "PreSel","phi_Z",  50, 0, 500, vZ.Phi(), evtWeight );
...
void Analyzer::processEvents(){ 
  ...
  //CutFlowAnalysis("root://se01.indiacms.res.in:1094//cms/store/user/sthakur/ntuple_MuMC_20171223/MuMC_20171223/DY1JetsToLL_MuMC_20171223/DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/DY1JetsToLL_MuMC_20171223/171223_144255/0000/DY1JetsToLL_MuMC_20171223_Ntuple_1.root", "PF", "");
