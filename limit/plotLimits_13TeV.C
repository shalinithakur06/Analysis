	   ...
	   Float_t xMax_   = 50, bool obs = false, bool rootfile = false )
{
  ...
  int nMassPoints = 3;
  TString massFiles [3] = {"higgsCombineExitedLepton_mu.Asymptotic.mH2000.root",
  "higgsCombineExitedLepton_mu.Asymptotic.mH4000.root",
  "higgsCombineExitedLepton_mu.Asymptotic.mH6000.root"};
...
void plotLimits_13TeV(){
  ...
  c1->SetGridy();
  c1->cd(1);
  plot("LimitCalc", "", "", "ExLepton", "mu", "13TeV", "mu", 0.2, false, true);
