...
void getProEvent_13TeV(){
  ...
  if(is2016Data){	
    ...
    eleDataEvtDBS["EleRunBver2v2_Merged.root"]  =135301240 ;  
    ...
    eleDataEvtDBS["EleRunFv1_Merged.root"    ]  =33041957  ;
    eleDataEvtDBS["EleRunGv1_Merged.root"    ]  =76538905  ;
    eleDataEvtDBS["EleRunHver2v1_Merged.root"]  =79589911  ; 
